...
caminho = os.path.join('users', 'desktop', 'curso', 'arquivo.txt')
# print(caminho)
diretororio, arquivo = (os.path.split(caminho))
# print(arquivo)
# print(diretororio)
# print(os.path.exists(caminho))
# print(os.path.abspath('.'))
print(os.path.basename(caminho))
print(os.path.dirname(diretororio))

# os.listdir para navegar em caminhos
#/D/learningpython/aula171_ospath.py

caminho = os.path.join('/D','learningpython', 'aula;...')
print(caminho)
