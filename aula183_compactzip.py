...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula183_compactzip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula183_compactzip.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula183_descompactado'
...
#lendo arquivos em um zip
with ZipFile(CAMINHO_COMPACTADO, 'r') as zip:
    for arquivo in zip.namelist():
        print(arquivo)

# zip.extractall (extrai tudo do zip)
