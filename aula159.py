...
class Direcoes(enum.Enum): #ou enum.auto() enumera automaticamnete
    ESQUERDA = 1
    DIREITA = 2

print(Direcoes(1).name, Direcoes(1).value) #nome da chave, valor do membro)
